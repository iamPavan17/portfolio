...
const offlineProjectData = [
  {
    ...
    title: "Theme Editor",
    body: "A VS Code IDE extension for customizing a theme with a live preview. Also includes saving the theme settings.",
  ...
  },
  {
    ...
    body: "An e-commerce website for Coffee products.",
